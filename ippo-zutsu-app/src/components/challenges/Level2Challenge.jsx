    ...
    if (isRunning) {
      ...
      simulationIntervalRef.current = setInterval(() => {
        setSteps(prevSteps => {
          ...
          // Check if the user has reached 80 steps to trigger the battle
          if (newSteps === 80 && !showBattlePopup) {
          ...
          // Check if the user has reached 100 steps to trigger victory
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 p-3 sm:p-4">
      ...
      <div className="flex justify-between items-center mb-4 sm:mb-8">
        ...
        <h1 className="text-lg sm:text-xl font-anime text-white">Level 2 Challenge</h1>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/70">
          ...
          >
            ...
            <p className="text-center text-purple-200 mb-6">
              A wild Black Wolf appears! What will you do?
            </p>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-anime text-white">Intermediate's Path</h2>
...
export default Level2Challenge; 